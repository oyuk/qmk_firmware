 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | \ | Alt  |  L1  | Cmd  | EISU |                                       | KANA | = +  | [  { | ]  } | L2 \ |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
 *                                        | LALT(SPC) | Right|  | Left | Right  |
 *                                 ,------|------|------|       |------+--------+------.
 *                                 | L2   |      | ---  |       |  Up  |        |      |
 *                                 | Space| \ |  |------|       |------|  = +   | Enter|
 *                                 |      |      |  N   |       | Down |        |      |
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_BSLS, KC_LALT,    LT(SYMB,KC_NO),  KC_LGUI,KC_LANG2,
                                                      LALT(KC_SPC),  KC_RIGHT,
                                                              KC_HOME,
                                                LT(MDIA,KC_SPC),KC_BSLS, KC_N,
        // right hand
...
[MDIA] = LAYOUT_ergodox(
    ...
    // right hand
       ...
       KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       LCTL(LSFT(KC_TAB)), KC_TRNS, KC_TRNS, LCTL(KC_TAB), KC_TRNS, KC_MPLY,
